...
<body>
    ...
    <div class="login-clean" style="background-color:rgb(255,255,255);padding:3px;">
        <form method="post">
            ...
            <p class="help-block" style="width:244px;height:38px;color:rgb(133,131,131);font-size:15px;margin-bottom:0px;margin-top:-33px;margin-right:0PX;margin-left:36px;">EL CURSO SE ELIMINO </p>
