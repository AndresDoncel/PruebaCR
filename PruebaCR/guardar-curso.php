<?php 
	...
	$nombre_electiva=$_POST['nombre_electiva'];
	$profesor=$_POST['profesor'];
	$cupos=$_POST['cupos_disponibles'];
	$descripcion=$_POST['descripcion'];
	
	$query="INSERT INTO cursos (nombre_electiva, profesor, cupos_disponibles,descripcion ) VALUES ('$nombre_electiva','$profesor','$cupos','$descripcion')";
...
<body>
    ...
    <div class="login-clean" style="background-color:rgb(255,255,255);padding:3px;">
        <form method="post">
            ...
            <p class="help-block" style="width:244px;height:38px;color:rgb(133,131,131);font-size:15px;margin-bottom:0px;margin-top:-33px;margin-right:0PX;margin-left:36px;">EL CURSO SE AGREGO </p>
            <p class="help-block" style="margin-left:52px;margin-top:-8px;">CORRECTAMENTE </p>
            <div class="form-group"><a class="btn btn-primary btn-block" role="button" href="dashboard-admin.php">Regresar al Portal</a></div>
        </form>
    </div>
