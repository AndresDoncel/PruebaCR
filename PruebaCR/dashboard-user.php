...
<body>
    ...
    <div id="datos-personales"><i class="material-icons" id="icon-contacto">search</i>
        <h3>Inscripción de Electivas</h3>
        <hr>
    </div>
    <div>
        <div class="container">
                    ...
                    <div style=" height: 370px; overflow: scroll;" id="full-container">
                        <div id="container-contact">
                            ...
                            <div id="container-options">
                              <button style="height: 117px;" class="btn btn-primary btn-block btn-options" type="button"> <i class="material-icons icon-options">done</i></button>
                            </div>
