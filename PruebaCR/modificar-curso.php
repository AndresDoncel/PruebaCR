            ...
            <div class="row">
                    ...
                    <form name="modificar_usuario" method="POST" action="mod_curso.php">
                        <div class="form-group">
							...
							<input type="hidden" name="id" value="<?php echo $id; ?>">
                                <input type="text" name="nombre_electiva" size="25" value="<?php echo $row['nombre_electiva']; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group"><span class="inputs-color-icons input-group-addon"><i class="material-icons">person</i></span>
                                <input type="password" name="profesor" size="25" value="<?php echo $row['profesor']; ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group"><span class="inputs-color-icons input-group-addon"><i class="material-icons">format_list_numbered</i></span>
                                <input type="text" name="cupos_disponibles" size="25" value="<?php echo $row['cupos_disponibles']; ?>" />
                            </div>
                        </div>
                ...
                <div class="col-md-4" id="my-form-derecha">
                        <div class="form-group">
                            ...
                            <div class="input-group"><span class="inputs-color-icons input-group-addon"><i class="material-icons">text_format</i></span>
                                <textarea class="form-control" value="<?php echo $row['descripcion']; ?>" name="descripcion" placeholder="Descripción" style="height:129px;"></textarea>
                            </div>
                        </div>
                </div>
                <div class="col-md-2"></div>
